		  ...
		  <option value="Thrill">Thrill</option>
			...
			<div class="main-content">
				...
				if filterBy = "Action" then
					whereClause = "WHERE genre = 'Action'"
				elseif filterBy = "Comedy" then
					whereClause = "WHERE genre = 'Comedy'"
				elseif filterBy = "Drama" then
					whereClause = "WHERE genre = 'Drama'"
				elseif filterBy = "Romance" then
					whereClause = "WHERE genre = 'Romance'"
				elseif filterBy = "Horror" then
					whereClause = "WHERE genre = 'Horror'"
				elseif filterBy = "Fantasy" then
					whereClause = "WHERE genre = 'Fantasy'"
				elseif filterBy = "Thrill" then
					whereClause = "WHERE genre = 'Thrill'"
				else
					whereClause = ""
				end if
				...
				End If
					...
					pid = rs("postid")
						...
						response.write "<p style='text-align:center;'><a href='../login.html'><img src='" & avatar & "' class='img-circle' width='40px' height='38px'></a></p>"
						response.write "<div>"
						response.write "<p class='main-name'><a href='../login.html'>" & rs.fields("complete_name") & "</a></p>"
						...
						response.write "<div><a href='../login.html'><img src='../assets/images/like.png' width='30' height='30'></a> "& rs.fields("upvote")&"</div>"
						response.write "<div><a href='../login.html'><img src='../assets/images/dislike.png' width='30' height='30'></a> "& rs.fields("downvote")&" </div>"
						...
						response.write "<div><a href='../login.html'><img src='../assets/images/comment.png' width='30' height='30'></a>"& total_comments &"</div>"
						response.write "</div>"
						response.write "</div>"
						response.write "</div>"
