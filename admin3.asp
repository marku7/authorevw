...
<%
	...
	if filterBy = "Action" then
		whereClause = "WHERE genre = 'Action' AND category = 'Short Story'"
	elseif filterBy = "Comedy" then
		whereClause = "WHERE genre = 'Comedy' AND category = 'Short Story'"
	elseif filterBy = "Drama" then
		whereClause = "WHERE genre = 'Drama' AND category = 'Short Story'"
	elseif filterBy = "Romance" then
		whereClause = "WHERE genre = 'Romance' AND category = 'Short Story'"
	elseif filterBy = "Horror" then
		whereClause = "WHERE genre = 'Horror' AND category = 'Short Story'"
	elseif filterBy = "Fantasy" then
		whereClause = "WHERE genre = 'Fantasy' AND category = 'Short Story'"
	elseif filterBy = "Thrill" then
		whereClause = "WHERE genre = 'Thrill' AND category = 'Short Story'"
	else
		whereClause = "WHERE category = 'Short Story'"
	end if
